...
@Service
class InventoryItemsService(@Autowired val inventoryItemsRepository: InventoryItemsRepository) {

    fun addInventoryItem(orgInventoryItem: OrgInventoryItems):OrgInventoryItems=inventoryItemsRepository.insert(orgInventoryItem)
